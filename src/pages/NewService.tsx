...
const NewService = () => {
  ...
  const { clients, addService, prices } = useApp();
          ...
          <div className="space-y-6 max-w-[640px] mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2">
                ...
                <input type="text" placeholder="Rua, número, bairro..." className="finput" />
              </div>
            </div>
          </div>
        )}
            ...
            <div className="bg-white text-black p-10 rounded-r-sm shadow-pop mb-8 font-dmsans">
              <div className="flex justify-between items-start mb-10">
                <div>
                  ...
                  <div className="text-[11px] font-bold uppercase tracking-widest text-gray-400">Proposta de Serviço #0042</div>
                </div>
                <div className="text-right text-[11px] font-bold uppercase tracking-widest text-gray-400">Data: 05/03/2026</div>
              </div>
              <div className="grid grid-cols-2 gap-8 mb-10">
                <div>
                  <div className="text-[10px] font-bold uppercase tracking-widest text-gray-400 mb-1">Cliente</div>
                  <div className="font-bold">João da Silva</div>
                </div>
                <div>
                  <div className="text-[10px] font-bold uppercase tracking-widest text-gray-400 mb-1">Serviço</div>
                  <div className="font-bold">Assentamento de Piso</div>
                </div>
              </div>
              <div className="space-y-3 mb-10">
                ...
                <div className="flex justify-between pt-4">
                  ...
                  <span className="font-montserrat font-extrabold text-2xl text-amber">R$ 4.000</span>
                </div>
              </div>
